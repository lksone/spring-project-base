...
import com.lks.watermark.domain.FontAttribute;
...
public class ImageUtils {
    ...
    public static File createImage(String text, Color color,Integer fontSize, Float degree, Float alpha) throws WatermarkException {
        ...
        FontAttribute fontAttribute1 = getWidthAndHeight(text, font);

        int width = fontAttribute1.getWidth();
        int height = fontAttribute1.getHeight();
    ...
    private static FontAttribute getWidthAndHeight(String text, Font font) {
        ...
        fontAttribute.setHeight(height);
        fontAttribute.setWidth(width);
