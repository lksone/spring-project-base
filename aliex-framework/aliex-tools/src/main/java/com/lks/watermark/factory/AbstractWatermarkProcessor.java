package com.lks.watermark.factory;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.io.IoUtil;
import com.lks.watermark.Converter;
import com.lks.watermark.FileTypeUtils;
import com.lks.watermark.domain.WatermarkParam;
...
public abstract class AbstractWatermarkProcessor implements WatermarkProcessor {
    ...
    public byte[] addWatermark(WatermarkParam watermarkParam) throws WatermarkException {
        try {
            com.lks.watermark.LicenseUtils.verificationLicense();
